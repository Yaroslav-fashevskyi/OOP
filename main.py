...
def main():
    forms = [
        ...
        # generated
        Form("Анна", 1985, "Футбол", 10, "Чемпіон області", True, 2500.0),
        Form("Петро", 1975, "Біг", 4, "Переможець марафону", True, 3200.0),
        Form("Олександр", 1990, "Футбол", 6, "Кубок регіону", False, 2700.0),
        Form("Ірина", 1988, "Читання", 8, "100 прочитаних книг", True, 2200.0),
        Form("Марина", 1992, "Немає", 3, "Нема", False, 1800.0),
    ]
